...
const Footer = () => {
  return (
   ...
   <Link href="/images/Ebuka.Moses.Okoye_Resume.pdf" target="_blank" rel="noopener noreferrer" className="text-[#a1a1a1] hover:text-white transition-colors duration-200">
    Download My Resume
   </Link>
